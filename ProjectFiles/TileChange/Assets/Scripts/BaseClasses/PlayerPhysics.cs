...
public class PlayerPhysics : MonoBehaviour {
	...
	public void DetectWalls(ref float deltaX,ref float deltaY,Vector3 p,float Distance,LayerMask WallMask,LayerMask KeyMask,ref bool Gotkey){
		    ...
		    if(Physics.Raycast(ray,out hit,Distance,KeyMask)){
			Gotkey = true;
